...
export function ProposalBuilder() {
  ...
  return (
    <>
      <div className="min-h-screen portfolio-bg py-12 px-4 flex items-center justify-center" style={{ marginLeft: '-500px', marginRight: '-500px', paddingLeft: '500px', paddingRight: '500px' }}>
